# these are all from plyr and all credit is to the plyr authors and maintainters (i.e. Hadley)
# shoving these here to avoid the plyr dependency which is unstable with dplyr
